...
<html lang="tr">
  ...
  <body>
    ...
    <div class="row-icerik">
      <h5 style="padding: 10px; font-weight: bold; margin-bottom: -5px;">Ayarlar</h5>
      
      <p class="duyuruAlani"><i class="fa-solid fa-bullhorn"></i> <a class="duyuruBaslik" >Duyuru:</a> Bu bölüm bakımdadır.</p>
